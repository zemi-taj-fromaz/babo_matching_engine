#ifndef BABOMATCHINGENGINE_ORDER_TRACKER_H
#define BABOMATCHINGENGINE_ORDER_TRACKER_H
...
{
#if defined(LIQUIBOOK_ORDER_KNOWS_CONDITIONS) // TODO - check this
...
{
  if (delta < 0 && static_cast<int32_t>(open_qty_) < std::abs(delta)) {
...
template <class OrderPtr>
const OrderPtr& OrderTracker<OrderPtr>::ptr() const
{
  return order_;
}

template <class OrderPtr>
OrderPtr& OrderTracker<OrderPtr>::ptr()
{
  return order_;
}
...
#endif // BABOMATCHINGENGINE_ORDER_TRACKER_H
